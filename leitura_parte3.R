## PARTE 3: Trata das pesquisas de 2016Q2 até 2016Q4
## Versão de teste. Estado atual:
# -- Lê dicionário 2tri2016 até 4tri2016
# -- Lê arquivo PNADC_022016
...
file <- unzip(zip, list = TRUE)$Name %>%
  grep("Input.*2Tri\\_2016.*\\.sas", ., value = TRUE)
